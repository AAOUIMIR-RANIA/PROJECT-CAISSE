...
<body class="bg-dark ">
<h1 class=" text text-center  text-primary"><p>APPLICATION DE GESTION DE CAISSE</p></h1>
<div class="container">
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4">
   ...
   <table  class="table table-hover table-bordered border-warning" >
    <thead><h2 class="text-center text-warning">Liste Des Articles</h2> </thead>
           ...
           <?php
              ...
              // output data of each row
                ...
                echo "<tr> <td><h2>".$row["id"]."</h2></td> <td><img width=30% src=images/".$row["id"].".png /></td> <td><h2>".$row["nomArticle"]."</h2></td> <td><h2>".$row["prix"]."</h2></td> </tr> ";
        ...
        <div class="col-md-6">
            ...
            <input type="submit" value="valider" class="btn btn-warning"> </p>
             </form>
...
<a class="text text-warning"    href="achat.php?idcommande=<?php echo $idcommande+1; ?> "> Nouvelle commande</a>
<p class="text text-warning">Ajouter une commande:</p> 
...
<div class="container">
	...
	echo "<h2 class='text text-center  text-warning'> liste des achats de la commande:".$idcommande."</h2>";
	
	echo '<table border=1 class="table table-hover table-bordered border-warning  ">';
  ...
  // output data of each row
	...
	echo "<tr> <td><a href=achat.php?idcommande=".$idcommande."&idannule=".$row["id"].">annuler</a></td> <td><img width=30%  src=images/".$row["idArticle"].".png /></td> <td><h2>".$row["nomArticle"]."</h2></td> <td><h2>".$row["quantite"]."</h2></td> <td><h2>".$row["prixArticle"]."</h2></td></tr> ";
